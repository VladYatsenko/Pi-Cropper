...
import static com.yatsenko.picropper.widgets.checkbox.CheckBox2.GRID;
import static com.yatsenko.picropper.widgets.checkbox.CheckBox2.OVERLAY;
...
import com.yatsenko.picropper.utils.AndroidUtilities;
import com.yatsenko.picropper.utils.extensions.ViewKt;
import com.yatsenko.picropper.core.Theme;
import com.yatsenko.picropper.utils.AndroidUtilities;
...
public class CheckBoxBase {
    ...
    public void draw(Canvas canvas) {
        ...
        //corner color
        String color = backgroundType == CheckBox2.OVERLAY ? Theme.checkBoxCheckedBorderOverlay : isChecked ? Theme.checkBoxCheckedBorder : Theme.checkBoxUncheckedBorder;
        ...
        if (roundProgress > 0) {
            ...
            if (checkProgress != 0) {
                if (checkedText != null) {
                    ...
                    if (backgroundType == CheckBox2.OVERLAY){
                        textSize += 2f;
                        y += 3f;
                    }
